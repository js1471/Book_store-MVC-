...
{ [Authorize]
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email_Id,Address,Mobile_Number")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email_Id,Address,Mobile_Number")] Author author)
        {
            if (id != author.Id)
            {
                return NotFound();
